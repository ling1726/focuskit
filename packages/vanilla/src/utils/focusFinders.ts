...
export function findPrevFocusable(container: HTMLElement, current: HTMLElement) {
  elementWalker.root = container;
...
export function findNextFocusable(container: HTMLElement, current: HTMLElement) {
  elementWalker.root = container;
  elementWalker.currentElement = current;
  elementWalker.filter = allFocusable;
...
export function findAllFocusable(container: HTMLElement, filter: (element: HTMLElement) => boolean) {
